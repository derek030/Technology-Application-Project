        ...
        <div class="justify-center">
            <div class="sm:mx-auto sm:w-full md:max-w-xl">
                ...
                <p class="mt-2.5 text-center text-sm text-darkblue-primary font-poppins">
                    ...
                    <a href="login.php" class="font-semibold leading-6 text-state-blue">Login</a>
                </p>
            </div>
                ...
                <form class="space-y-6 needs-validation" novalidate>
                    ...
                    <div class="mt-6 space-y-6">
                        <div class="relative flex gap-x-3">
                            ...
                            <div class="leading-6">
                                <label for="comments" class="font text-darkblue-primary font-poppins">I agree to
                                    <a href="#" class="font-semibold leading-6 text-state-blue">Terms of service</a> and
                                    <a href="#" class="font-semibold leading-6 text-state-blue">Privacy
                                        policy</a>.</label>
                            </div>
                        </div>
                        <div>
